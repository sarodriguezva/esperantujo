...
const locationInfo = {
    ...
    "Virtual": {
      ...
      description: "105-a Universala Kongreso de Esperanto Virtual en 2020 (debido a la pandemia del COVID-19)",
      attendeees: "1860"
    },
    "Virtual2": {
      year: 2021,
      ...
      title: "Congreso Virtual",
      description: "106-a Universala Kongreso de Esperanto Virtual en 2021 (debido a la pandemia del COVID-19)"
    },
    "Canada": {
      year: 2022,
...
function reset() {
	document.getElementById("locationInfo").innerHTML = '<img class="locationImage" src="img/main.jpg" alt="Universala Kongreso"><br><strong>Mapa mundi con ubicaciones de los últimos 10 Congresos de Esperanto</strong><br>Haz clic en alguno de los pequeños botones para ver información sobre el lugar.';
	document.getElementById("locationInfo").scrollIntoView();
}